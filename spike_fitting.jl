...
# ╔═╡ d24e4576-b066-11ec-3cd9-55bf3d0f89a1
begin
	using CSV
	using Plots
	using DataFrames
...
# ╔═╡ fd3fcbe9-f028-48fb-b454-bb41e19c3ad1
PC038_S12 = CSV.read("neuron firing data/csv/PC038_S12.csv",DataFrame)

# ╔═╡ 76f65b0a-ef0a-487a-85dd-37ead71c19ca
begin
	plot(PC038_S12[!,"t"] .* 1000,PC038_S12[!,"Y"],xlabel="time in ms",ylabel="V in mV")
	savefig("sweep.png")
end

# ╔═╡ 82d49652-668e-4490-bba6-a28a3386edb5
plot(PC038_S12[!,"t"] .* 1000,PC038_S12[!,"C"],xlabel="time in ms",ylabel="Applied Current pA")

# ╔═╡ 238950da-0ab0-493d-b1fc-b54cb1968a36
begin
	## Constants
	const C_m     = 100.0       # μF/cm², membrane capacitance
	const G_NaMax = 40     # mS/cm², maximum conductivity of Na channel
	const G_KMax  = 35      # mS/cm², maximum conductivity of K channel
	const G_L     = 0.3     # mS/cm², leak conductivity
	const V_r  = -68        # mV, resting potential
	const V_Na =  40        # mV, Nernst voltage for Na 
...
# ╔═╡ a31dd320-e814-4728-968a-7e529c9781e4
begin
	# Injected Current Function
	I_inj(t) = 150 * (531.25 <= t <= 1531.2)
end

# ╔═╡ 248b583c-1557-4399-9fa4-816a352fe39e
...
# ╔═╡ a549f336-5498-4529-a5b6-bf6778a5d286
begin
	## Run Model:
...
# ╔═╡ 3fd06541-fdad-4772-aa29-f71fa6d33690
begin
	p1 = plot(sol.t, sol[4,:], legend=false, ylabel="Voltage [mV]")
	plot!(PC038_S12[!,"t"] .* 1000,PC038_S12[!,"Y"])
	p2 = plot(sol.t, I_inj.(sol.t), legend=false, lc=:red, ylabel="Current [pA]")
