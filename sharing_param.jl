...
# ╔═╡ 3f1d6168-5554-11ed-3d12-1b3b1a1ad0c2
begin
...
# ╔═╡ a8a937b7-4726-42c3-97cc-51c5695a4649
begin
	@parameters t
	D = Differential(t)
	@parameters τ=0.001 H=20.0 λ=5.0 r=0.15
end

# ╔═╡ e3e69df6-15d2-469a-9d1b-4e32846c0379
...
# ╔═╡ d180284c-2c99-4d03-a2bf-ecf4fe438816
begin
	@named JR1 = JansenRit()
	@named JR2 = JansenRit()
	sys = [JR1, JR2]
	eqs = [ JR1.jcn ~ JR2.x - JR1.x,
		JR2.jcn ~ JR1.x - JR2.x]
	@named comb = ODESystem(eqs, systems = sys)
end

# ╔═╡ 0f9dd549-5fbd-47c9-a063-6eb31cea36d4
simpl = structural_simplify(comb)
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "32fad2c4fa00877b4088e719d668b50e3d262c2a"
...
deps = ["ArrayInterfaceCore", "ArrayInterfaceGPUArrays", "GPUArraysCore", "GenericSchur", "LinearAlgebra", "Printf", "SparseArrays", "libblastrampoline_jll"]
git-tree-sha1 = "9aa023b6f5afd95d155b589171813d93b769aa7a"
