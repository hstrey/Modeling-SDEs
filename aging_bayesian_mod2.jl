...
p = [0.8165,2.2335,0.013,0.2800,0.6610,0.5933]
...
chain = sample(model, NUTS(0.65), 2000, init_theta = [time_mean[1],0.8165,2.2335,0.013,0.2800,0.6610,0.5933])
#summarystats(chain)
plot(chain)
